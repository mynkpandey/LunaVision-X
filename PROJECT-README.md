...
├── guidelines/
│   └── Guidelines.md
├── supabase/                      # Backend functions (not actively used)
├── utils/
...
This is an academic project. For contributions or suggestions, please contact the author.

---

## License

This project is created for educational purposes as part of Continuous Assessment 3, Spring 2025.

---

## Acknowledgments

- Original Figma Design: [LunaVision-X AI Lunar Analysis](https://www.figma.com/design/ZgLXgP7A2Rs13Kv0AnrPlh/LunaVision-X-AI-Lunar-Analysis)
- React, Vite, Three.js, and all open-source libraries used
- Indian Space Research Organisation (ISRO) for Chandrayaan-2 mission
